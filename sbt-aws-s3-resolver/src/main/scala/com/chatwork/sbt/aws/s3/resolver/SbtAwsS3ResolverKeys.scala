...
trait SbtAwsS3ResolverKeys {
  ...
  lazy val s3Resolver = SettingKey[(String, String) => Resolver]("s3resolver", "Takes name and bucket url and returns an S3 resolver")
  lazy val s3ResolverWithCredentialsProviderChain = SettingKey[(String, String, AWSCredentialsProviderChain) => Resolver]("s3resolver", "Takes name and bucket url and returns an S3 resolver")
  lazy val s3ResolverWithCredentialProfileName = SettingKey[(String, String, String) => Resolver]("s3resolver", "Takes name and bucket url and returns an S3 resolver")
