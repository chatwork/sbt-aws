...
addSbtPlugin("com.chatwork" % "sbt-aws-s3" % "1.0.15")

addSbtPlugin("com.chatwork" % "sbt-aws-cfn" % "1.0.15")

addSbtPlugin("com.chatwork" % "sbt-aws-eb" % "1.0.15")
```
...
addSbtPlugin("com.chatwork" % "sbt-aws-s3" % "1.0.16-SNAPSHOT")

addSbtPlugin("com.chatwork" % "sbt-aws-cfn" % "1.0.16-SNAPSHOT")

addSbtPlugin("com.chatwork" % "sbt-aws-eb" % "1.0.16-SNAPSHOT")
```
